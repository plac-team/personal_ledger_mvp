...
/// @nodoc
class _$DailyExpenseEntityCopyWithImpl<$Res, $Val extends DailyExpenseEntity>
    implements $DailyExpenseEntityCopyWith<$Res> {
  _$DailyExpenseEntityCopyWithImpl(this._value, this._then);
...
class _$DailyExpenseEntityImpl implements _DailyExpenseEntity {
  ...
  @override
  String toString() {
    return 'DailyExpenseEntity(date: $date, price: $price, category: $category)';
  }
...
abstract class _DailyExpenseEntity implements DailyExpenseEntity {
  const factory _DailyExpenseEntity(
      ...
      required final String category}) = _$DailyExpenseEntityImpl;
